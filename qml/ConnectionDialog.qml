        ...
        GroupBox {
            ...
            ColumnLayout {
                ...
                RadioButton {
                    ...
                    onCheckedChanged: if (checked) connectionDialog.selectedType = "SERIAL"
            ...
            GridLayout {
                ...
                ComboBox {
                    ...
                    indicator: Canvas {
                        ...
                        Connections {
                            target: cbSocketHost
                            function onPressedChanged() { socketHostCanvas.requestPaint(); }
                        }
            ...
            GridLayout {
                ...
                ComboBox {
                    ...
                    indicator: Canvas {
                        ...
                        Connections {
                            ...
                            function onPressedChanged() { serialDeviceCanvas.requestPaint(); }
                        }
                ...
                ComboBox {
                    ...
                    indicator: Canvas {
                        ...
                        Connections {
                            target: cbBaudRate
                            function onPressedChanged() { baudRateCanvas.requestPaint(); }
                        }
        ...
        GroupBox {
            ...
            GridLayout {
                ...
                ComboBox {
                    ...
                    currentIndex: 2 // 500000
                    onCurrentTextChanged: connectionDialog.canSpeed = parseInt(currentText)
                    
                    indicator: Canvas {
                        id: canSpeedCanvas
                        x: cbCanSpeed.width - width - cbCanSpeed.rightPadding
                        y: cbCanSpeed.topPadding + (cbCanSpeed.availableHeight - height) / 2
                        width: 12
                        height: 8
                        contextType: "2d"
                        ...
                        Connections {
                            target: cbCanSpeed
                            function onPressedChanged() { canSpeedCanvas.requestPaint(); }
                        }
                    ...
                    contentItem: Text {
                        leftPadding: 8
                        rightPadding: cbCanSpeed.indicator.width + cbCanSpeed.spacing
                        text: cbCanSpeed.displayText
                        font: cbCanSpeed.font
                        color: ThemeManager.textColor
                        verticalAlignment: Text.AlignVCenter
                        elide: Text.ElideRight
                    }
                    ...
                    background: Rectangle {
                        color: ThemeManager.inputBackgroundColor
                        border.color: cbCanSpeed.activeFocus ? ThemeManager.inputFocusBorderColor : ThemeManager.inputBorderColor
                        border.width: 1
                        radius: 3
                    }
                    
                    popup: Popup {
                        y: cbCanSpeed.height - 1
                        width: cbCanSpeed.width
                        implicitHeight: contentItem.implicitHeight
                        padding: 1
                        ...
                        contentItem: ListView {
                            clip: true
                            implicitHeight: Math.min(contentHeight, 200)
                            model: cbCanSpeed.popup.visible ? cbCanSpeed.delegateModel : null
                            currentIndex: cbCanSpeed.highlightedIndex
